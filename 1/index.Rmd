...
* **Accueil** et introduction du cycle et du webinaire - **10 minutes**

* **Mise en perspective** : le chercheur **Antonio Casilli**, expert des plateformes numériques et du digital labor - **50 minutes** *- dont temps de questions-réponses de 10 minutes.*

* **Présentation participante** : Les principales notions (données, intelligence artificielle et open data) et le cadre juridique par Datactivist - **50 minutes**


* Temps de questions-réponses avec les participants dans le chat - **10 minutes**
...
## Acceuil et introduction au cycle de webinaire

---

### Mot d'acceuil de l'INTEFP

**Insérer les vidéos ici...**

---

### .red[La révolution des données] dans le monde du travail et dans nos métiers

.center[![](img/cycle.png)]
...
# .red[Mise en perspective]

## Par le chercheur Antonio Casilli

---

class: inverse, center, middle

# .red[Présentation participante]

## Les principales notions (données, intelligence artificielle et open data) et le cadre juridique
