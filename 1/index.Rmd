...
### .red[Attention !] 
Il faut ouvrir le lien dans un nouvel onglet de votre navigateur. Il faudra se rendre sur cet onglet pendant les questions (nous vous préviendrons). 
...
Une fois vos réponses ajoutées, revenez sur le webinaire ! 

---

<iframe allowfullscreen frameborder="0" height="100%" mozallowfullscreen style="min-width: 500px; min-height: 600px" src="https://app.wooclap.com/events/GIGQEC/questions/637626f88ceb9b95e13c5c20" width="100%"></iframe>
...
7./ **Des données dans un format ouvert** : Ce format ne doit pas être la propriété d'une organisation en particulier (.xls) et doit être gouverné par ses usagers
...
distinguer Algos, algos publics, IA (diagramme de Venn ?)

---

class: middle, center
## À vous de jouer !
### Ajoutez les mots manquants à la définitions des algorithmes de la CNIL
...
<iframe allowfullscreen frameborder="0" height="100%" mozallowfullscreen style="min-width: 500px; min-height: 600px" src="https://app.wooclap.com/events/GIGQEC/questions/63767870a3177098b7e05426" width="100%"></iframe>

---

### Algorithmes, IA, code source 

distinguer le cas de modèles auto-apprenants et de modèles procéduraux
