...
.pull-left[Une donnée quantitative est une variable ou grandeur qui est 
représentée par des nombres que l’on peut additionner, soustraire,
multiplier, etc…
]
...
.pull-left[Une donnée qualitative est une variable qui désigne des catégories 
ou des niveaux. 
Parfois, une variable catégorielle est représentée par des nombres, mais 
les additionner (ou soustraire, multiplier, etc…) n’a pas de sens. C’est le 
cas des numéros de départements]
